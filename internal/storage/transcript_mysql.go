...
func (db *mysqlStore) SaveTranscriptMessage(message TranscriptMessage) error {
...
func (db *mysqlStore) RecentTranscriptMessages(chatID int64, threadID, beforeMessageID, limit int) ([]TranscriptMessage, error) {
